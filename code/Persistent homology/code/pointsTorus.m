...
%
% OUTPUT:
%   points - a gridLength^2 x 4 matrix. Each row contains the x,y,z, and w
%       coordinates of a point from the gridLength x gridLength square grid
%       on the 2D unit torus in 4D, plus noise.
%
% CONTSTANTS:
