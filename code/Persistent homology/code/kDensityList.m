function densities = kDensityList(points, k)
...
%
% NOTES: This m-file is slow for large datasets. 
%
% CONSTANTS:
...
if N*blockSize>maxMatrixSize
    ...
    disp('Constant blockSize has been lowered. Expect a long computation time. Please open kDensityList.m for details.')
end
