function [connected_components loops triangles]= comp_betti(incomp,N)
...
connected_components=betti_number(1); % number of connected components
loops=betti_number(2); % number of loops
triangles=numTriangles; % number of triangles
